...
const barrier6 = textureLoader.load("images/barrier-6.png");
...
var cannonFire = new Audio('Audio/cannon.flac');
    ...
    */
  var playerHealth = 6;
  var barrierGeometry = new THREE.PlaneGeometry( 2.0, 3.0, 1.0 );
  var barrierMaterial = new THREE.MeshBasicMaterial( {map: barrier6, alphaTest: 0.5} );
...
var ammoHand = function(pos, texture) {
  ...
  this.mesh.rotation.y = 180 * Math.PI;
  scene.add(this.mesh);
}

var leftAmmoHand = new ammoHand(new THREE.Vector3(0, 5, -3), leftHandTexture);
var rightAmmoHand = new ammoHand(new THREE.Vector3(-2, 5, -3), rightHandTexture);
